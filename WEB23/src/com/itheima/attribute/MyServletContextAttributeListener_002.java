...
public class MyServletContextAttributeListener_002 implements ServletContextAttributeListener{
	...
	public void attributeRemoved(ServletContextAttributeEvent servletContextAttributeEvent) {
		System.out.println(servletContextAttributeEvent.getName());//删除域中的name
