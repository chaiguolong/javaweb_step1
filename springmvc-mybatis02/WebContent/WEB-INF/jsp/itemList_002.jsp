...
<html>
	...
	<body>
		<form action="itemList_002_submit" method="post" accept-charset="utf-8">
			查询条件:
		...
		查询列表:
		<form action="${pageContext.request.contextPath}/updates_002.action" method="post" accept-charset="utf-8">
			<table width="100%" border=1>
				<tr>
				...
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}/itemEdit_002.action?id=${item.id}">修改</a></td>
