...
<script type="text/javascript">
	function addCart(){
		...
		location.href="${pageContext.request.contextPath}/productServlet_001?method=addProductToCart&pid=${product.pid}&buyNum="+buyNum;
	}
</script>
</head>
		...
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div>
						<a href="${pageContext.request.contextPath}/productServlet_001?method=productList&cid=${cid }&currentPage=${currentPage}">返回列表页面</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
