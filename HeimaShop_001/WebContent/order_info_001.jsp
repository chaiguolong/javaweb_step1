			...
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						...
						<c:forEach items="${order.orderItems}" var="orderItem" varStatus="">
							<tr class="active">
		...
		<div>
			...
			<form class="form-horizontal" style="margin-top: 5px; margin-left: 150px;">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="password" class="form-control" id="inputPassword3" name="name" placeholder="请输收货人" value="${user.name}">
					</div>
				</div>
				<div class="form-group">
					<label for="confirmpwd" class="col-sm-1 control-label">电话</label>
					<div class="col-sm-5">
						<input type="password" class="form-control" id="confirmpwd" placeholder="请输入联系方式" name="telephone" value="${user.telephone}">
					</div>
				</div>
			</form>
