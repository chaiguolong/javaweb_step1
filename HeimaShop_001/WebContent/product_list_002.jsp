...
<body>
	...
	<!-- 引入header.jsp -->
	<jsp:include page="/header_002.jsp"></jsp:include>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${pageBean.list }" var="pro">
			...
			<div class="col-md-2" style="height:250px">
				<a href="${pageContext.request.contextPath }/productServlet_002?method=productInfo&pid=${pro.pid}&cid=${cid}&currentPage=${pageBean.currentPage}"> 
					<img src="${pageContext.request.contextPath }/${pro.pimage}" width="170" height="170" style="display: inline-block;">
				</a>
				<p>
					<a href="${pageContext.request.contextPath }/productServlet_002?method=productInfo&pid=${pro.pid}&cid=${cid}&currentPage=${pageBean.currentPage}" style='color: green'>${pro.pname }</a>
				</p>
				<p>
