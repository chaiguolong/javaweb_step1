	...
	<head>
		...
		<script type="text/javascript">
			function delProFromCart(pid){
				if(confirm("您是否要删除该项?")){
					location.href="${pageContext.request.contextPath}/productServlet_002?method=delProFromCart&pid="+pid;
				}
			}

			function clearCart(){
				if(confirm("您是否要清空购物车?")){
					location.href="${pageContext.request.contextPath}/productServlet_002?method=clearCart";
				}
			}
		</script>
	</head>
