	...
	<head>
		...
		<script type="text/javascript">
			function delProFromCart(pid){
				if(confirm("您是否要删除该项?")){
					location.href="${pageContext.request.contextPath}/productServlet_001?method=delProFromCart&pid="+pid;
				}
			}

			function clearCart(){
				if(confirm("您是否要清空购物车?")){
					location.href="${pageContext.request.contextPath}/productServlet_001?method=clearCart";
				}
			}
		...
		<div class="container">
				...
				<div style="margin:0 auto; margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${cart.cartItems}" var="entry" varStatus="">
								<tr class="active">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/productServlet_001?method=submitOrder">
