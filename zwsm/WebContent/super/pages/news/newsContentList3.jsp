...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	$(document).ready(function(){
		...
		//初始化当前页面cookie值
		if($.cookie('newContentListQuery3')){
			var query = $.evalJSON($.cookie('newContentListQuery3'));
			for(var i in query){
	...
	function saveQueryCookie(){
		...
		$.cookie('newContentListQuery3', $.toJSON(query), {expires: 1});
	}
	...
	//编辑
	function edit(id){
		window.location.href = "/esf/NewsContent_toContentInfo.jspx?page=" + $('.pcontrol input').val() + "&mode=3&newsContent.contentid=" + id;
	}
  ...
  <body class="tbody">
	<!-- 日志列表 -->
	<div class="txt_title">资讯中心 &gt; 待发布资讯列表   </div>
	<!-- 工具栏 -->
	<div class="toolbg toolbgline toolheight nowrap">
		...
		<div id="toolbarlist" class="nowrap left">
			...
			<input type="hidden" id="releasemark" name="releasemark" value="0"/>
