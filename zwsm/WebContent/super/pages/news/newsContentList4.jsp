...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	$(document).ready(function(){
		...
		//初始化当前页面cookie值
		if($.cookie('newContentListQuery4')){
			var query = $.evalJSON($.cookie('newContentListQuery4'));
			for(var i in query){
	...
	function saveQueryCookie(){
		...
		$.cookie('newContentListQuery4', $.toJSON(query), {expires: 1});
	}
	...
	//编辑
	function edit(id){
		window.location.href = "/esf/NewsContent_toContentInfo.jspx?page=" + $('.pcontrol input').val() + "&mode=4&newsContent.contentid=" + id;
	}
  ...
  <body class="tbody">
	<!-- 日志列表 -->
	<div class="txt_title">资讯中心 &gt; 已发布资讯列表   </div>
	<!-- 工具栏 -->
