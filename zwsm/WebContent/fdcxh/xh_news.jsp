		...
		<div class="topsearch">
			<table width="100%" height="30" border="0" cellspacing="0"
				...
				<tr>
					<td width="8"></td>
					<td>
						您现在的位置：<a href="/fdcxh">首页</a> ><s:property value="#request.category.name"/>
					</td>
				</tr>
			</table>
		</div>
				...
				<ul class="lst">
					...
					<s:if test="%{#request.contentlist.size() != 0}">
						<s:iterator value="#request.contentlist" var="c">
							<li><a href='/xh/WebFdcxhAction_news.jspx?contentid=<s:property value="#c.contentid" />&categoryid=<s:property value="#request.category.categoryid"/>' target="_blank"><s:property value="#c.title" /></a></li> 
						</s:iterator>
					</s:if>
					<s:else>
						<li>没有相关新闻</li>
