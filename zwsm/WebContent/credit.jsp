...
function doPage(page) {
	...
	window.location.href= "/" + action + "list.jspx?pageno="+page;
}
</script>
</head>
...
<div class="top">您现在的位置：<a href="/index.jsp">首页 </a>>诚信档案</div>
<div class="hg"></div>
<div class="content">
	<div class="left1">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td colspan="2">
					<div class="lbox" style="padding:0px;">
						...
						<s:iterator value="#request.revokelist" var="revoke" status="index">
			...
			<tr>
				...
				<span><a href="/revokelist.jspx">更多</a></span>
				</td>
			</tr>
		</table>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td colspan="2">
					<div class="lbox" style="padding:0px">
						...
						<s:iterator value="#request.continuouslist" var="continuous" status="index">
						<s:if test="#index.index < 8">
							<tr>
			...
			<tr>
				<td colspan="2" class="yshu">
				<span><a href="/continuouslist.jspx">更多</a></span>
				</td>
			</tr>
		</table>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td colspan="2">
					<div class="lbox">
						<s:iterator value="#request.complaintlist" var="complaint" status="index">
						<s:if test="#index.index < 8">
						<li>
							<span>
			...
			<tr>
				<td colspan="2" class="yshu">
				<span><a href="/complaintlist.jspx">更多</a></span>
				</td>
			</tr>
		</table>
	</div>
