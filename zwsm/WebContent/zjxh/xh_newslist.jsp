	...
	<body>
		...
		<div class="topsearch">
			<table width="100%" height="30" border="0" cellspacing="0" cellpadding="0">
				<tr><td width="8"></td>
					<td>
						您现在的位置：<a href="/zjxh">首页</a> > <s:property value="#request.self.name"/>
					</td>
				</tr>
			</table>
		</div>
				...
				<dl>
					...
					<dd>
						<s:iterator value="#request.categorylist" var="c">
							<li class="a">
								<a href='/zjxh/newslist.jspx?categoryid=<s:property value="#c.categoryid" />'><s:property value="#c.name" /></a>
							</li>
						</s:iterator>
					</dd>
				</dl>
							...
							<s:if test="%{#request.contentlist.size() != 0}">
								<s:iterator value="#request.contentlist" status="s">
									<li>
										...
										<s:else>
											<a href="/zjxh/news.jspx?contentid=<s:property value="%{contentid}"/>&categoryid=<s:property value="#request.categoryid"/>" class="main" title="<s:property value="title" />" target="_blank">
												<s:property value="title" escape="false"/>
											 </a>
										</s:else>
									</li>
