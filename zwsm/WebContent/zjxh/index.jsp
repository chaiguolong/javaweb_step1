...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/zjxh/js/jquery.KinSlideshow-1.2.1.min.js" ></script>
	...
	<body>
		...
		<div class="xscontent">
			<s:include value="/include/zjxh_index.html"></s:include>
		</div>
		<div class="hg"></div>
		<s:include value="/zjxh/xh_zjxh_link.html"></s:include>
		<div class="hg01"></div>
