...
<script type="text/javascript">
	...
	$.validator.addMethod(
		...
		function(value,element,params){
			...
			$.ajax({
				"async":false,
				"url":"${pageContext.request.contextPath}/checkUsernameServlet_001",
				"data":{"username":value},
				"type":"POST",
				"dataType":"json",
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="myform"class="form-horizontal" style="margin-top: 5px;" method="post" action="${pageContext.request.contextPath}/RegisterServlet_001">
