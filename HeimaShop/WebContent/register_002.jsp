...
<script type="text/javascript">
	...
	$.validator.addMethod(
		...
		function(value,element,params){
			...
			//value:输入的内容
			//element:被校验的元素对象
			//params:对输入的username进行ajax校验
			$.ajax({
				"async":false,
				"url":"${pageContext.request.contextPath}/checkUsernameServlet_002",
				"data":{"username":value},
				"type":"POST",
				"dataType":"json",
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" id="myform" style="margin-top: 5px;" method="post" action="${pageContext.request.contextPath}/RegisterServlet_002">
