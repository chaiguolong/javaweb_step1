...
public class TestMyServlet2_001{
     //8.创建一个map集合
     ...
     public void testReadWEBXml(){
         try{
             ...
             Document document = 
                 saxReader.read("/Users/mymac/.vim/bundle/JavaUnit.vim/bin/cn/itheima/web/servlet1/web.xml");
             //3.获取根元素节点
             ...
             for(Element element : list){
                 ...
                 if("servlet-mapping".equals(element.getName())){
                     ...
                     //11.将servletName作为key类获取servletClass的值
     ...
     public void testMyServlet(){
         try{
             ...
             Method method = clazz.getMethod("service",new Class<?>[0]);
