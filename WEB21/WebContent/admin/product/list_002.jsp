...
<script type="text/javascript">
			function addProduct(){ window.location.href = "${pageContext.request.contextPath}/adminAddProductUI_002";
			}
			function delProduct_002(pid){
				var isDel = confirm("您确认要删除吗?");
				if(isDel){
					//要删除
					location.href = "${pageContext.request.contextPath}/adminDelProduct_002?pid="+pid;
					}
			}
$(function(){
...
<body>
	<br>
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/adminSearchProductList_002" method="post">
		商品名称: <input type="text" name="pname" id="pname" value="${condition.pname}" /> &nbsp; &nbsp;
							...
							<c:forEach items="${productList}" var="product" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
											href="${ pageContext.request.contextPath }/adminUpdateProductUI_002?pid=${product.pid}">
											<img
											src="${pageContext.request.contextPath}/images/i_edit.gif"
											border="0" style="CURSOR: hand">
									</a></td>

									<td align="center" style="HEIGHT: 22px"><a href="javascript:void(0)" onclick="delProduct_002('${product.pid}')"> <img
