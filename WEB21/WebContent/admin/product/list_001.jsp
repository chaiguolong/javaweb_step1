...
<HTML>
	<HEAD>
		...
		<script lang="javascript" src="${pageContext.request.contextPath}/js/jquery-1.11.3.min.js"></script>
		<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/adminAddProductUI_001";
			}
			...
			function delProduct(pid){
				...
				if(idDel){
				//要删除
				location.href = "${pageContext.request.contextPath}/adminDelProduct_001?pid="+pid;
			}
		}
...
$("#cid option[value='${condition.cid}']").prop("selected",true);
	...
	<body>
		...
		<form id="Form1" name="Form1"
			action="${pageContext.request.contextPath}/adminSearchProductList_001"
			method="post">
